...
function showMonthAnalysis(item) {
  ...
  modalInner.innerHTML = `
    ...
    <div>
        ...
        <p>Income for ${item['month']} ${item['year']}: ${item.income} ron</p>
        <p>Spent Total: ${item.total} ron</p>
    </div>
    <div>
    <p>Food: ${item.food} ron</p>
    <p>Coffe and Out: ${item.coffeeAndOut} ron</p>
    <p>Other: ${item.other} ron</p>
    <p>Shopping: ${item.shopping} ron</p>
    <p>Travel: ${item.travel} ron</p>
    </div>
    ${notes}
    <p>Balance: ${item.balance} ron</p>
    `
  chart(item)
